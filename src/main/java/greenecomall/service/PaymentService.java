...
public class PaymentService {
    ...
    private void activateUser(User user) {
        ...
        switch (locked.getRegistrationPlan()) {
            case FAST_START -> treeService.placeNewFastStartUser(locked);
            case STANDARD -> {
            ...
            case LEVEL_2 -> treeService.placeNewDirectLevelUser(locked, 2);
            case LEVEL_3 -> treeService.placeNewDirectLevelUser(locked, 3);
            case LEVEL_4 -> treeService.placeNewDirectLevelUser(locked, 4);
        }
    }
